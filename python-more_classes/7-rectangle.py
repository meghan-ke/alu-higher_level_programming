#!/usr/bin/python3
"""Module that defines a Rectangle class with customizable print symbol and instance tracking."""


class Rectangle:
    """Represents a rectangle with width, height, symbol printing, and instance tracking."""
    ...
    def __repr__(self):
        """Return a string that can recreate this rectangle with eval()."""
