#!/usr/bin/python3
"""Defines a Rectangle class with full functionality, including a classmethod to create squares."""


class Rectangle:
    """Represents a rectangle with width, height, and customizable features."""
    ...
    def __repr__(self):
        """Return a string to recreate this rectangle using eval()."""
        return "Rectangle({}, {})".format(self.__width, self.__height)

    def __del__(self):
        """Called when the instance is deleted. Decrements counter."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
